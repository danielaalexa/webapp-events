        ...
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
           ...
           <!-- Qui inizia La Card -->
            ...
            <a class="eventi-regione">Eventi in Sicilia</a>
            <a class="eventi-regione">Eventi in Basilicata</a>
            <a class="eventi-regione">Eventi in Toscana</a>
            <a class="eventi-regione">Altri...</a>
